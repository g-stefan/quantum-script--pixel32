...
cmdX xyo-cc --mode=$ACTION @build/source/quantum-script-extension-pixel32.static.compile
cmdX xyo-cc --mode=$ACTION @build/source/quantum-script-extension-pixel32.dynamic.compile
